                ...
                <div className='grid gap-4 lg:grid-cols-3 grid-cols-1'>
                    <div className='lg:p-10 p-4 rounded-lg bg-primary-600 hover:bg-gradient-to-b hover:to-red-600 hover:from-gray-900'>
                        ...
                        <div className='space-y-4 text-white'>
                            <p> If you're looking for a way to hire professional hackers to hack a cell phone remotely, you've come to the right place. </p>
                            <p>
                            ...
                            <p>
                                We also offer a phone hacking service, so you can hire a professional hacker to get the job done right. Whether you're looking to hire a certified ethical hacker for personal or business purposes, we can help you find the right person for the job.   </p>
                        </div>
                    </div>
                    <div className='lg:p-10 p-4 rounded-lg bg-primary-600 hover:bg-gradient-to-b hover:to-red-600 hover:from-gray-900'>
                        <div className='lg:p-6 p-3 w-fit rounded-lg  bg-black hover:bg-white'>
                        ...
                        <div className='space-y-4 text-white'>
                            ...
                            <p> 										When it comes to hacking, many people think of malicious activities like stealing someone's identity or breaking into computer systems. However, there is a growing industry of professional hackers who offer their services to businesses and individuals who want to penetrate their Web site security. While hiring a hacker may seem like an easy way to fix your security issues, it's important to protect your database against malicious attacks.</p>
