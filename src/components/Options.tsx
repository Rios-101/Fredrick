...
const Options = () => {
    return (
        <div>
            <div className='bg-primary-500 pt-10 lg:pb-[10rem] pb-10'>
                <div className='lg:w-[74%] mx-2 lg:mx-auto lg:grid-cols-3 grid-cols-1 grid lg:gap-10 gap-3'>
                    <div className='border-dashed px-2 border-primary-300 lg:border-r-2 border-b-2 lg:border-b-0 pb-2 lg:pb-0'>
                        <div className="flex justify-center lg:justify-start py-3">
                            <div className='bg-primary-600 w-fit px-3 py-2 text-primary-200 text-sm'>
                                Social Media Hack
                            </div>
                        </div>
                        <div className='space-y-4 text-primary-300'>
                            <p> Are you looking to hire a hacker to penetrate Social Media? Want to recover your social media accounts with the help of real hacker? Want to connect to the dark web without the hassle of who is a professional hacker ? We have set of top hackers to social media accounts.</p>
                            <p> From our black hat hackers to top penetration testers, we can secure and recover lost account such as Instagram, Facebook and other social media accounts.</p>
                            <p> To find a social media accounts hacker from our professional list. Our certified ethical hacker will provide you access into any account. </p>
                        </div>
                    </div>
                    <div className='border-dashed px-2 border-primary-300 lg:border-r-2 border-b-2 lg:border-b-0 pb-2 lg:pb-0'>
            ...
            <h2 className='lg:pb-20 pb-8 text-2xl font-bold text-center text-white'>Trusted Over 2300+ Individuals in the World</h2>
        </div>
    )
}
